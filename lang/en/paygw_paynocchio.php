...
$string['paynocchio_activation_subject'] = 'Wallet successfully activated.';
...
$string['paynocchio_mail_topup_message_help'] = 'You can use {$a->user_name} and {$a->sum} placeholders to show Name and Sum in letter.';
