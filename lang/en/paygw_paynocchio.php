...
$string['paynocchio_activation_subject'] = 'Email subject for successful wallet activation.';
$string['paynocchio_activation_message'] = 'Email message for successful wallet activation.';
$string['paynocchio_mail_topup_subject'] = 'Email subject for successful top up.';
$string['paynocchio_mail_topup_message'] = 'Email message for successful top up.';
$string['paynocchio_delete_subject'] = 'Email subject for wallet deletion.';
$string['paynocchio_delete_message'] = 'Email message for wallet deletion.';
$string['paynocchio_transaction_subject'] = 'Email subject for successful transaction.';
$string['paynocchio_transaction_message'] = 'Email message for successful transaction.';
...
$string['gatewaydescription'] = 'Outstanding long-term rewarding system. Earn up to 10% rewarding point per topup and payment.';
