...
class withdraw_complete extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            ...
            'request_uuid' => new external_value(PARAM_TEXT, 'The external_request_id coming back from Paynocchio'),
     ...
     * @param string $request_uuid Paynocchio external_request_id
    ...
    public static function execute(
        ...
        if($user) {
            ...
            email_to_user($paymentuser, $supportuser, get_string('paynocchio_withdraw_subject', 'paygw_paynocchio'), get_string('paynocchio_withdraw_message', 'paygw_paynocchio', ['username' => $paymentuser->firstname . ' ' . $paymentuser->lastname, 'sum' => $amount ]));
