...
class paynocchio_helper {
     ...
     * @param string $secret Paynocchio secret.
     ...
     *
     * @param string $authorizationid The Paynocchio-generated ID for the authorized payment to capture.
    ...
    /**
     * Captures order details from Paynocchio.
     *
    ...
    /**
     * Request for Paynocchio REST oath bearer token.
     *
     * @return string
     */
