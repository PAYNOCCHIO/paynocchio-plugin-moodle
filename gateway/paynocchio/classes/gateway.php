...
class gateway extends \core_payment\gateway {
    ...
    public static function add_configuration_to_gateway_form(\core_payment\form\account_gateway $form): void {
        ...
        $mform->addElement('text', 'clientid', get_string('clientid', 'paygw_paynocchio'));
        $mform->setType('clientid', PARAM_TEXT);
        $mform->addHelpButton('clientid', 'clientid', 'paygw_paynocchio');

        $mform->addElement('text', 'secret', get_string('secret', 'paygw_paynocchio'));
        $mform->setType('secret', PARAM_TEXT);
        $mform->addHelpButton('secret', 'secret', 'paygw_paynocchio');

        $options = [
            'live' => get_string('live', 'paygw_paynocchio'),
            'sandbox'  => get_string('sandbox', 'paygw_paynocchio'),
        ];

        $mform->addElement('select', 'environment', get_string('environment', 'paygw_paynocchio'), $options);
        $mform->addHelpButton('environment', 'environment', 'paygw_paynocchio');
    }
