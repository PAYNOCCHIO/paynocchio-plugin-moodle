...
/**
 * Privacy Subsystem implementation for paygw_paynocchio.
 *
...
namespace paygw_paynocchio\privacy;
...
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider {
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_paynocchio');
        $record = $DB->get_record('paygw_paynocchio', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_paynocchio', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
